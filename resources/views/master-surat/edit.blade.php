...
@section('content')
    <div class="container mt-4">
        <div class="card">
            ...
            <form method="POST" action="{{ route('master-surat.update', $masterSurat->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="nama_surat" class="form-label">Nama Surat</label>
                    <input value="{{ $masterSurat->nama_surat }}" type="text" name="nama_surat" id="nama_surat"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="isi_surat" id="isi_surat" class="form-control" rows="5">
                        {{ $masterSurat->isi_surat }}
                    </textarea>
                </div>
